class NavHandler {
    ...
    */
    generateContent(){
        ...
        let centerPane            = document.getElementById('formAdmin');
    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.formAdmin.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.formAdmin.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'formAdmin'){
                    geotab.addin.formAdmin.blur();
                } else {
                    geotab.addin.formAdmin.focus(global.api, global.state);
                }
            }
        }, 100);
    }
