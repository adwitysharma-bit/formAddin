class NavHandler {
    ...
    */
    generateContent(){
        ...
        let centerPane            = document.getElementById('driverForm');
    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.driverForm.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.driverForm.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'driverForm'){
                    geotab.addin.driverForm.blur();
                } else {
                    geotab.addin.driverForm.focus(global.api, global.state);
                }
            }
        }, 100);
    }
